    ...
    for i in range(num_iter):
        ...
        def closure():
            ...
            if i % 1 == 0:
                ...
                print('Iteration = ', i, 'Train loss ', loss.detach().cpu().numpy())
                print ('Iteration %05d    Train loss %f  Actual loss %f Actual loss orig %f  Noise Energy %f' % (i, loss.detach().cpu().numpy(),true_loss.detach().cpu().numpy(),loss2.detach().cpu().numpy(),noise_energy.detach().cpu().numpy()), '\r', end='')
            return loss
